...
%prep
%setup -q -n cmark-0.31.1
cd %{_builddir}/cmark-0.31.1
pushd ..
cp -a cmark-0.31.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724170227
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcmark.so.0.31.1
/usr/lib64/libcmark.so.0.31.1
